...
data class YaMoneyDimensions(
    ...
    val compactSelectionControlSize: Dp = 32.dp,
    ...
    val transactionEditorAmountHeight: Dp = 80.dp,
    val transactionEditorAmountWidth: Dp = 200.dp,
    val transactionEditorRowHeight: Dp = 68.dp,
